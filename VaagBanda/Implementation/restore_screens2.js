...
write(path.join(BASE, 'screens/expenses/AddExpenseScreen.tsx'), `import React, { useEffect, useState } from 'react'
...
// ─── ProfileScreen.tsx ───
write(path.join(BASE, 'screens/profile/ProfileScreen.tsx'), `import React, { useState } from 'react'
...
console.log('\n🎉 All remaining screens restored!')